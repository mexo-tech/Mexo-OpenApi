...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: mexo.io
    ...
    // for example: wss://wsapi.mexo.io/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.mexo.io/openapi/ws
